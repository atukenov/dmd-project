            ...
            <nav aria-label="Progress" className="mb-8">
              <div className="px-4">
                ...
                <ol className="hidden sm:flex items-center justify-between w-full relative">
                  ...
                  <div className="absolute top-4 left-0 right-0 h-0.5 bg-card-border z-0"></div>
                  
                  {steps.map((step, stepIdx) => (
                    <li key={step.id} className="relative z-10 flex flex-col items-center">
                      {/* Step circle */}
                      <div
                        className={`flex h-8 w-8 items-center justify-center rounded-full transition-all duration-200 shadow-sm ${
                          step.id === currentStep
                            ...
                            : 'bg-content-bg text-text-muted border-2 border-card-border'
                        }`}
                      >
                        {steps.findIndex(s => s.id === currentStep) > steps.findIndex(s => s.id === step.id) ? (
                      ...
                      {/* Step name */}
                      <p className={`mt-3 text-center text-xs font-medium max-w-20 leading-tight ${
                        step.id === currentStep 
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        {steps.findIndex(s => s.id === currentStep) === steps.length - 1 ? (
                          ...
                          <span className="text-xs font-semibold">{steps.findIndex(s => s.id === currentStep) + 1}</span>
                        )}
                      </div>
                      <div>
